...
class GitHubAgent:
    ...
    def format_messages(self, all_cl_messages: list[cl.Message]):
        """
    ...
    async def on_mcp_connect(self, connection, session: ClientSession):
        self.MCP_TOOLS.append(connection)
    
    async def on_mcp_disconnect(self, name: str, session: ClientSession):
